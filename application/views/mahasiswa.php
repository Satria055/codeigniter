<div class="content-wrapper">
    ...
    <section class="content">
      ...
      <a class="btn btn-info" href="<?php echo base_url('mahasiswa/print') ?>"><i class="fa fa-print"></i> Print</a>
    ...
    <?php echo form_close() ?>
      ...
      <table class="table table-striped">
        ...
        <tr>
          ...
          <td><?php echo anchor('mahasiswa/detail/'.$mhs->id,
          '<div class="btn btn-success btn-sm"><i class="fa fa-search-plus"></i></div>')?></td>
          <td onclick="javascript: return confirm('Apakah anda yakin menghapus data ini ?') ">
          <?php echo anchor('mahasiswa/hapus/'.$mhs->id, 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="exampleModalLabel" style="text-align:center">FORM TAMBAH DATA MAHASISWA</h4>
